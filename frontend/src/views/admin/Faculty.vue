  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Description", value: "FacultyDescription" },
  ...
  methods: {
    ...
    async deleteItemConfirm() {
      try {
        ...
        await axios({
          url: `http://localhost:3000/faculty/delete?id=${this.editedItem._id}`,
          method: "DELETE",
          headers: {
            "auth-token": token,
          },
    ...
    async save() {
      try {
        ...
        if (this.isAddItem == false) {
          await axios({
            url: `http://localhost:3000/faculty/update?id=${this.editedItem._id}`,
            data: user,
            method: "PUT",
            headers: {
              "auth-token": token,
          ...
          await axios({
            url: `http://localhost:3000/faculty/add`,
            data: user,
            method: "POST",
            headers: {
              "auth-token": token,
      ...
      (this.name = ""), (this.description = ""), this.initialize();
      this.isAddItem = false;
      this.close();
    },
  },
